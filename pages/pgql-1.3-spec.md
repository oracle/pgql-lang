...
The changes to unquoted identifiers, string literals and SELECT and GROUP BY clauses described below are only effective when using the new `FROM MATCH ..` query style
