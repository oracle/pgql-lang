        ...
        for (int i = 0; i < size; i++) {
          ...
          switch (literal.getExpType()) {
            ...
            case TIMESTAMP_WITH_TIMEZONE:
              ...
              break;
            default:
              // error message for unsupported expressions in IN list is already generated by the parser
              // we simply pass through here to not generate an ugly stack trace
              arrayElementType = ExpressionType.INTEGER;
              break;
          }
        }
